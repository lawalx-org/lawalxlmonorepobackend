/*
  ...
  - The values [FILE_CREATED] on the enum `ActivityActionType` will be removed. If these variants are still used in the database, this will fail.
...
-- AlterEnum
ALTER TYPE "public"."NotificationType" ADD VALUE 'FILE_CREATED';
