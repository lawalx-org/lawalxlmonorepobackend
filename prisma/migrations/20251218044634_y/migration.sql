...
-- AddForeignKey
ALTER TABLE "public"."ShowWidget" ADD CONSTRAINT "ShowWidget_stackBarChartId_fkey" FOREIGN KEY ("stackBarChartId") REFERENCES "public"."StackBarChart"("id") ON DELETE CASCADE ON UPDATE CASCADE;
